...
from app.models import QidianSignNew
from app import db
...
def signnews(url):
    ...
    for info in infos:
        ...
        new_model = QidianSignNew(title=title, author=author, classes=classes, bookid=bookid, state=state, authorid=author_id, ranking=ranking)
