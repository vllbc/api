...
from app.models import QidianRecom
from app import db
...
def recoms(url):
    ...
    for info in infos:
        ...
        new_model = QidianRecom(title=title, author=author, classes=classes, bookid=bookid, state=state, authorid=author_id, ranking=ranking)
