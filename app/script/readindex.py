...
from app.models import QidianReadIndex
from app import db
...
def readindexs(url):
    ...
    for info in infos:
        ...
        new_model = QidianReadIndex(title=title, author=author, classes=classes, bookid=bookid, state=state, authorid=author_id, ranking=ranking)
