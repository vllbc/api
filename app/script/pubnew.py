...
from app.models import QidianPubNew
from app import db
...
def pubnews(url):
    ...
    for info in infos:
        ...
        new_model = QidianPubNew(title=title, author=author, classes=classes, bookid=bookid, state=state, authorid=author_id, ranking=ranking)
